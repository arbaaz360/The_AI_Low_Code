 ...
 */
export type ExprOp = "lit" | "ref" | "eq" | "neq" | "gt" | "gte" | "lt" | "lte" | "and" | "or" | "not" | "if" | "coalesce";
...
export type Expr = LitExpr | RefExpr | BinaryExpr | NotExpr | IfExpr | CoalesceExpr;
/** Type guard: value is an Expr AST node (has op and it's a known op). */
export declare function isExpr(value: unknown): value is Expr;
