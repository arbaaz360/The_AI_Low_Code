...
export declare function isEventRef(v: unknown): v is EventRef;
...
export interface ActionRunnerDeps {
    ...
    dataRequestStartedCreator?: (payload: {
        requestId: string;
        dataSourceId: string;
    }) => {
        type: string;
    ...
    dataRequestSucceededCreator?: (payload: {
        requestId: string;
        resultKey: string;
        result: unknown;
    }) => {
    ...
    dataRequestFailedCreator?: (payload: {
        requestId: string;
        error: string;
    }) => {
        type: string;
