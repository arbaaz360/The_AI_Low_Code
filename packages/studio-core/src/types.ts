...
export type Command =
  ...
  | { type: "UpdateEvents"; nodeId: string; events: Record<string, unknown[]> }
  ...
  | { type: "SetDataSources"; dataSources: FormDoc["dataSources"] }
  | { type: "SetPageEvents"; pageEvents: FormDoc["pageEvents"] };
